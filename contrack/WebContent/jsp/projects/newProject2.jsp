...
<head>
	...
	<title>Contrack - New Project (2 of 3)</title>
	<LINK REL="stylesheet" HREF="../stylesheets/v2.css" TYPE="text/css">
	<%= com.sinkluge.utilities.Widgets.fontSizeStyle(session) %>
</head>
<body>
<form action="newProject2.jsp" method="POST">
<font size="+1">New Project (2 of 3) - Architect Contact</font><hr>
<a href="../">Contrack</a> &gt; <a href="newProject.jsp">New Project (Owner Contact)</a> &gt; New Project (Architect Contact)<hr>
<%
String name = null;
String value = null;
if (request.getParameter("ocontact_id") != null) {
	name = "ocontact_id";
	value = request.getParameter("ocontact_id");
} else {
	name = "ocompany_id";
	value = request.getParameter("ocompany_id");
}
out.print(FormHelper.hidden(name, value));
%>
<table>
	<tr>
...
<%
	...
	while(rs.next()) {
		...
		if (contact_id != null) {
%>
	<div><a href="newProject3.jsp?<%= name %>=<%= value %>&acontact_id=<%= contact_id %>">
...
%>
	<div><a href="newProject3.jsp?<%= name %>=<%= value %>&acompany_id=<%= rs.getString("company_id") %>">
