...
public class GenRFIDocument extends Report {

	private String attn, rfiNum, jobName, request, urgency, company, address, city, 
		state, zip, phone, fax, reply;
	ResultSet rs;
	
	public ReportContact getReportContact(String id, Database db) {
		String query = "select contact_id, company_id from rfi "
			+ "where rfi_id = " + id;
		ResultSet rs = null;
